...
But now we use a 'simple' trick:^[This trick will turn up again in a future part of this series, when we talk about the **little discs operad**.] replace the point $*$ with the contractible space
