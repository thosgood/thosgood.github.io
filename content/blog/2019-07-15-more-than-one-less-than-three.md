...
Something that I won't talk about, but simply mention instead, is the fact that double categories are exactly [_$2$-fold categories_](https://ncatlab.org/nlab/show/n-fold+category#fold_categories].
