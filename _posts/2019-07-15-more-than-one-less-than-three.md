...
![horizontal composition](/assets/post-images/2019-07-15-horizontal-2-composition.png){:class="img-responsive"}

but _also_ 'along 1-morphisms' (so-called _vertically_)

![vertical composition](/assets/post-images/2019-07-15-vertical-2-composition.png){:class="img-responsive"}
...
![squares](/assets/post-images/2019-07-15-double-square.png){:class="img-responsive"}
